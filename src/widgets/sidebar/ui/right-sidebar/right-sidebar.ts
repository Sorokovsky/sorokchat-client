...
import type { InputSignal, ModelSignal, Signal, Type } from '@angular/core';
...
@Component({
  ...
  imports: [NgComponentOutlet, NoBar, ToggleSidebar],
  templateUrl: './right-sidebar.html',
  styleUrl: './right-sidebar.scss',
})
export class RightSidebar {
  public readonly mappings: InputSignal<Mappings> = input.required<Mappings>();
  public readonly isOpen: ModelSignal<boolean> = model.required<boolean>();
